...
$(document).ready(function() {
  ...
  <?php
    ...
    $query = "SELECT * FROM tbl_withdraw_sparepart WHERE withdraw_Status ='Approve' OR withdraw_Status ='Refuse' ORDER BY withdraw_ID ASC LIMIT $offset,$record_show" or die("Error:" . mysqli_error());
