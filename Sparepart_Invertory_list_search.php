                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php $years = range(2000, strftime("%Y", time())); ?>
                            ...
                            <option><?php echo $year_select; ?></option>
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php $count_month = 0;
                                      do { $count_month = $count_month + 1; 
                                        ...
                                        WHERE  Iv_year='".$year_select."' 
                                        AND  Iv_month='".$count_month."' ";
                                        $result = mysqli_query($con,$sql);
                      
                                        if(mysqli_num_rows($result)>=1){ $count_Mfg = 0;?>
                                         <tr> <td><?php echo $count_month;?>/<?php echo $year_select;?></td>
                                    ...
                                    <?php } while($count_Mfg <= 4); ?>
                                        ...
                                        <?php }else{?>
                                            ...
                                            <td><?php echo $count_month;?>/<?php echo $year_select;?></td>
                                            <td>-</td>
                                            <td>-</td>
                                            <td>-</td>
                                            <td>-</td>
